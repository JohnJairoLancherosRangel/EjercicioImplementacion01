...
const DirectorPH = new Director("Programa TV", "Leftfield Pictures","https://s3.amazonaws.com/images.productionhub.com/profiles/logos/179712_k1mju2mdaw.jpg",
"Leftfield Pictures es una potencia de contenido sin guión con cientos de horas de programación premium innovadora y de vanguardia," + 
"que se transmite en varias redes importantes, OTT y plataformas teatrales.");

////// Creando un nuevo Actor ////
const Actor1PH = new Actor("Protagonista","Rick Harrison",
"https://es.wikipedia.org/wiki/Rick_Harrison#/media/Archivo:Rick_Harrison_by_Gage_Skidmore.jpg",
"Es un empresario estadounidense, conocido por ser el propietario de la tienda de empeño Gold & Silver Pawn Shop en Las Vegas.");

////// Creando una nueva serie (Relacion de Composicion con Categoria,Director,Actor)////
const SeriePH = new Serie("El Precio de la Historia",
"https://images-na.ssl-images-amazon.com/images/S/pv-target-images/9b2a228ecacc77e6337b41e9edf4cd862a18cd46d9622837d269698f15a8118b._RI_TTW_.jpg",
CategoriaHistoria,DirectorPH,Actor1PH);
...
const Actor2PH = new Actor("Protagonista","Corey Harrison",
"https://es.wikipedia.org/wiki/Corey_Harrison#/media/Archivo:Corey_from_Pawn_Stars_(cropped).jpg",
"Es un hombre de negocios y celebridad estadounidense, conocido por salir en la serie de televisión de History, El precio de la historia, que documenta su trabajo en la famosa casa de empeños, Gold & Silver Pawn Shop");

const Actor3PH = new Actor("Protagonista","Austin Russell",
"https://es.wikipedia.org/wiki/Chumlee#/media/Archivo:Chumleewithcrop.jpg",
"Es conocido por aparecer en el programa de televisión Pawn Stars, de History Channel, donde trabaja en la casa de empeños Gold and Silver en Las Vegas, con Rick Harrison.");
...
const Director2PH = new Director("Planificación","The History Channel",
"https://es.wikipedia.org/wiki/History#/media/Archivo:History_(2021).svg",
"Es un canal de televisión por suscripción propiedad de A&E Networks.");
